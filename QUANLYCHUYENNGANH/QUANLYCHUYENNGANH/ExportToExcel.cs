...
namespace QUANLYCHUYENNGANH
{
    class ExportToExcel
    {
        public void Export(DataTable dt, string sheetName, string title)
        {
            ...
            cl0.Value2 = "Trường Đại Học Sư Phạm Kỹ Thuật Vỉnh Long";

            cl0.ColumnWidth = 30;

            Microsoft.Office.Interop.Excel.Range head = oSheet.get_Range("A3", "K3");
            ...
            cl8.Value2 = "Điểm hệ 10";

            cl8.ColumnWidth = 10.0;

            Microsoft.Office.Interop.Excel.Range cl9 = oSheet.get_Range("I5", "I5");

            cl9.Value2 = "Điểm hệ 4";

            cl9.ColumnWidth = 10.0;

            Microsoft.Office.Interop.Excel.Range cl10 = oSheet.get_Range("J5", "J5");

            cl10.Value2 = "Điểm chữ";

            cl10.ColumnWidth = 10.0;

            Microsoft.Office.Interop.Excel.Range cl11 = oSheet.get_Range("K5", "K5");

            cl11.Value2 = "Lần học";

            cl11.ColumnWidth = 10.0;

            Microsoft.Office.Interop.Excel.Range rowHead = oSheet.get_Range("A5", "K5");
