...
namespace QUANLYCHUYENNGANH
{
    public partial class frmQuan_ly_thong_tin_chuyen_nganh : Form
    {
        ...
        private void hienthi()
        {
            ...
            cn.OpenConn();
            string sqlht = "select * from CHUYENNGANH";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (macn == ma)
            {
                ...
                {
                    string sqlsua = "update CHUYENNGANH set MACN='" + macn + "',MANGANH='" + manganh + "',TENCN='" + tencn + "' where  MACN='" + macn + "'";
        ...
        {
            dgvthongtin.DataSource = hienthiTK("select * from CHUYENNGANH where MACN like '%" + txtTK.Text.Trim() + "%'");
        }
    }
}
