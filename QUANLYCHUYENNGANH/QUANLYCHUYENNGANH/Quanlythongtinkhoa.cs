...
namespace QUANLYCHUYENNGANH
{
    public partial class frmQuanlythongtinkhoa : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (makhoa.IndexOf(" ") >= 0)
            {
                errorProvider1.SetError(txtmakhoa, "Email không chứa khoảng trắng!");
                return;
            }
            //else
            //{
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (makhoa.IndexOf(" ") >= 0)
            {
                errorProvider1.SetError(txtmakhoa, "Mã khoa không chứa khoảng trắng!");
                return;
            }
            //else
            //{
            ...
            if (tenkhoa.IndexOf(" ") < 0)
            {
                errorProvider1.SetError(txttenkhoa, "Tên khoa gồm 2 từ trở lên!");
                return;
            }
            //else
            //{
